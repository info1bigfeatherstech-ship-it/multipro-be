...
/** Example rows for the data sheet (multi-variant Flipkart-style sample). */
const EXAMPLE_PRODUCT_ROWS = [
  {
    name: 'Cotton Crew Neck T-Shirt',
    title: 'Cotton Crew Neck T-Shirt - Soft Everyday Wear',
    description:
      'Soft cotton tee. Keep name/title/description identical across all variant rows of this product.',
    category: 'Apparel',
    brand: 'ApexWear',
    status: 'active',
    isfeatured: 'false',
    ...
    productLeft: '',
    customMessage: '',
    productAttributes: 'Material:Cotton | Warranty:6 Months',
    images: '',
    hsnCode: '610910',
    gstRate: '5',
    isFragile: 'false',
  ...
  },
  {
    ...
    title: 'Portable Bluetooth Speaker Mini - Clear Bass',
    description: 'Single-variant example. Leave variantAttributes blank when there are no options.',
    ...
    productLeft: '',
    customMessage: '',
    productAttributes: 'Material:Plastic | Warranty:1 Year',
    images: '',
    hsnCode: '85182100',
    gstRate: '18',
    isFragile: 'false',
